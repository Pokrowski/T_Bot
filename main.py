...
def start_message(message):
    BOT.send_message(message.chat.id, 'Выбирите интересующую валюту', reply_markup=KEYBOARD_START)
...
def get_text_messages(message):
    ...
    if message.text == BUTTON_USD:
    ...
    elif message.text == BUTTON_BEST_BAY_VALUE:
        ...
        BOT.send_message(message.chat.id, values.get_sell_buy_value(),reply_markup=KEYBOARD_CHOICE)
